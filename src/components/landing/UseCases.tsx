...
const cases = [
  {
    ...
    subtitle: "Projects & Operations",
    desc: "Organize projects, meetings, and priorities in one structured page.",
  ...
  },
  {
    ...
    title: "Study Planner",
    subtitle: "Learning",
    desc: "Plan subjects, review cadence, and time blocks in one view.",
    preview: ["Weekly goals", "Time blocks", "Checklist"],
  },
  {
    emoji: "💰",
    title: "Budget Tracker",
    subtitle: "Personal Finance",
    desc: "Track income/expenses with category summaries and savings goals.",
    preview: ["Monthly overview", "Category", "Savings goal"],
  },
  {
    emoji: "🏋️",
    title: "Workout Planner",
    subtitle: "Health",
    desc: "Track workouts, meals, and progress in a clean dashboard.",
  ...
  },
  {
    ...
    title: "Reading Log",
    subtitle: "Hobby",
    desc: "Track books, quotes, and ratings in your personal library view.",
  ...
  },
  {
    ...
    title: "Goal Tracker",
    subtitle: "Growth",
    desc: "Connect quarterly goals, weekly habits, and lightweight reviews in one flow.",
    preview: ["Goals", "Key results", "Weekly review"],
  },
];
    ...
    <section id="use-cases" className="scroll-mt-20 px-4 py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-2 text-center text-sm text-muted-foreground">
          Build these with YEO — generate with AI or edit manually to match your style.
        </p>
